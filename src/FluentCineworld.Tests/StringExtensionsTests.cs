...
namespace FluentCineworld.Tests
{
    public class StringExtensionsTests
    {
        ...
        [InlineData("The Lion, The Witch & The Wardrobe", "the", "A", "A Lion, A Witch & A Wardrobe")]
        public void Replace_ReplacesStringAsExpected(string input, string oldValue, string newValue, string expectedOutput)
        {

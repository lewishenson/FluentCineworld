...
namespace FluentCineworld.Tests.Listings
{
    public class CinemaListingsTests
    {
        ...
        public void Constructor_GivenNullCinema_ThenArgumentNullExceptionThrown()
        {
            ...
            Action action = () => new CinemaListings(null, mockGetDatesQuery.Object, mockGetFilmsQuery.Object);
        ...
        public void Constructor_GivenNullGetDatesQuery_ThenArgumentNullExceptionThrown()
        {
            ...
            Action action = () => new CinemaListings(Cinema.LondonLeicesterSquare, null, mockGetFilmsQuery.Object);
        ...
        public void Constructor_GivenNullGetFilmsQuery_ThenArgumentNullExceptionThrown()
        {
            ...
            Action action = () => new CinemaListings(Cinema.LondonLeicesterSquare, mockGetDatesQuery.Object, null);
        ...
        public async Task RetrieveAsync_GivenValidConstructorArguments_ThenWillReturnFilms()
        {
            ...
            var date1Film1 = new Film { Id = "film-a" };
            var date1Film2 = new Film { Id = "film-b" };
            ...
            var date2Film1 = new Film { Id = "film-c" };
            var date2Film2 = new Film { Id = "film-d" };
            ...
            var cinemaListings = new CinemaListings(Cinema.LondonLeicesterSquare, mockGetDatesQuery.Object, mockGetFilmsQuery.Object);

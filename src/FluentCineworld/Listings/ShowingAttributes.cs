...
namespace FluentCineworld.Listings
{
    public static class ShowingAttributes
    {
        ...
        public static readonly ShowingAttribute Vip = new ShowingAttribute("vip", "VIP", ShowingAttributeType.Extra);
        ...
        public static readonly ShowingAttribute FourDX = new ShowingAttribute("4dx", "4DX", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute AutismFriendly = new ShowingAttribute("autism-friendly", "Autism friendly", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute Cinebabies = new ShowingAttribute("cinebabies", "Cinebabies", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute DBox = new ShowingAttribute("dbox", "DBox", ShowingAttributeType.ScreeningType);
        ...
        public static readonly ShowingAttribute Imax = new ShowingAttribute("imax", "IMAX", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute MoviesForJuniors = new ShowingAttribute("movies-for-juniors", "Movies for Juniors", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute ScreenX = new ShowingAttribute("screenx", "ScreenX", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute Subbed = new ShowingAttribute("subbed", "Subtitled", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute Superscreen = new ShowingAttribute("superscreen", "Superscreen", ShowingAttributeType.ScreeningType);
        public static readonly ShowingAttribute UnlimitedScreening = new ShowingAttribute("unlimited-screening", "Unlimited screening", ShowingAttributeType.ScreeningType);

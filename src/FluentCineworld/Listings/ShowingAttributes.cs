...
namespace FluentCineworld.Listings
{
    public static class ShowingAttributes
    {
        public static readonly ShowingAttribute Universal = new ShowingAttribute(
            "u",
            "U",
            ShowingAttributeType.AgeRestriction
        );
        ...
        public static readonly ShowingAttribute AlternativeContent = new ShowingAttribute(
            "alternative-content",
            "Alternative content",
            ShowingAttributeType.Extra
        );
        public static readonly ShowingAttribute Vip = new ShowingAttribute(
            "vip",
            "VIP",
            ShowingAttributeType.Extra
        );
        ...
        public static readonly ShowingAttribute TwoD = new ShowingAttribute(
            "2d",
            "2D",
            ShowingAttributeType.ScreeningType
        );
        ...
        public static readonly ShowingAttribute DBox = new ShowingAttribute(
            "dbox",
            "DBox",
            ShowingAttributeType.ScreeningType
        );
        public static readonly ShowingAttribute DolbyAtmos = new ShowingAttribute(
            "dolby-atmos",
            "Dolby Atmos",
            ShowingAttributeType.ScreeningType
        );
        ...
        static ShowingAttributes()
        {
            ...
            AgeRestrictions = All.Where(attribute =>
                    attribute.AttributeType == ShowingAttributeType.AgeRestriction
                )
                .ToList();
        }
    }
